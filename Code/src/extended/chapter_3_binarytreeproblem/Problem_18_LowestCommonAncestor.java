 ...
 * Desc:找到所给的两个节点的最近公共祖先,提供二叉树的根节点
 * 既然给出了根节点,那么使用后序遍历;
 * 进阶1:
 * <p>
 * <p>
...
public class Problem_18_LowestCommonAncestor {
    // 原问题,这是后序遍历;
    //这个方法返回的node 并不是当前遍历的头结点(返回头结点干嘛...)而是返回的是当前节点找到的那个最近公共节点;
    public static Node lowestAncestor(Node head, Node o1, Node o2) {
        //在当前head节点下,找到了o1或者o2,返回head;
        if (head == null || head == o1 || head == o2) {
            return head; //head如果为null的话,就返回null了;
        }
        Node left = lowestAncestor(head.left, o1, o2);
        Node right = lowestAncestor(head.right, o1, o2);
        if (left != null && right != null) {
            //都有返回值,说明o1和o2是在head节点下找到的,所以返回head;
            return head;
        }
        //left和right至少有一个为null,谁不为null返回谁;
    ...
    public static class Record1 {
        ...
        //主要的功夫都花在**前序遍历**二叉树,建立hashMap的过程了
    ...
    public static class Record2 {
        ...
        //initMap,这里只负责初始化map的key,key就是每个节点;
